      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-18">
          ...
          >
            ...
            <span
              className="font-display font-light text-2xl text-earth-200 tracking-widest"
              style={{ fontFamily: "Outfit, sans-serif" }}
            >
              SPORT
            </span>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden sm:flex items-center">
              <div
                className={`flex items-center gap-2 bg-dark-700 border rounded-full transition-all duration-300 ${
                  searchOpen
                    ? "border-fire-orange w-52 px-4 py-2"
                    : "border-dark-500 w-10 h-10 justify-center cursor-pointer hover:border-dark-400"
                }`}
              ...
              <div className="relative">
                ...
                {userMenuOpen && (
                  <div className="absolute right-0 top-12 bg-dark-800 border border-dark-600 rounded-xl p-3 min-w-[160px] shadow-xl animate-fade-in z-50">
                    <p className="text-earth-300 text-xs font-medium px-2 mb-2 truncate">
            ...
            <button
              ...
              className="hidden sm:flex items-center justify-center w-10 h-10 rounded-full bg-purple-500/20 border border-purple-500/40 text-purple-400 hover:bg-purple-500/30 hover:border-purple-500/60 transition-all duration-200"
            >
              <Settings size={18} />
            </button>
        ...
        {/* ── Mobile Menu ── */}
        <div
          className={`lg:hidden overflow-hidden transition-all duration-300 ${menuOpen ? "max-h-72 pb-4" : "max-h-0"}`}
        >
          {/* Mobile search */}
